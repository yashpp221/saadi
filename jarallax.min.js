...
!function(e) {
    ...
    var i, a, r = function() {
        ...
        for (var i in o)
            "undefined" != typeof n.style[i] && (n.style[i] = "translate3d(1px,1px,1px)",
    ...
    }(), l = navigator.userAgent.toLowerCase().indexOf("android") > -1, s = /iPad|iPhone|iPod/.test(navigator.userAgent) && !e.MSStream, c = !!e.opera, m = /Edge\/\d+/.test(navigator.userAgent), p = /Trident.*rv[ :]*11\./.test(navigator.userAgent), u = !!Function("/*@cc_on return document.documentMode===10@*/")(), d = document.all && !e.atob;
    t();
    var g = []
      , f = function() {
        function e(e, n) {
    ...
    f.prototype.init = function() {
        ...
        t.image.useImgTag && r && t.options.enableTransform ? (t.image.$item = document.createElement("img"),
        ...
        for (var i = t.$item; null !== i && i !== document && 0 === t.parentWithTransform; ) {
            ...
            a && "none" !== a && (t.parentWithTransform = 1,
            t.css(t.image.$container, {
        ...
        t.image.width && t.image.height ? e() : t.getImageSize(t.image.src, function(n, o) {
            t.image.width = n,
            t.image.height = o,
            e()
        }),
    ...
    f.prototype.coverImage = function() {
        ...
        if (e.image.width && e.image.height) {
            var t = e.image.$container.getBoundingClientRect()
              ...
              , g = 0
              , f = 0;
            m && (p = c < 0 ? c * Math.max(o, a) : c * (o + a),
            c > 1 ? d = Math.abs(p - a) : c < 0 ? d = p / c + Math.abs(p) : d += Math.abs(a - o) * (1 - c),
            p /= 2),
            u = d * l / s,
            u < n && (u = n,
            d = u * s / l),
            e.bgPosVerticalCenter = 0,
            !(m && d < a) || r && e.options.enableTransform || (e.bgPosVerticalCenter = (a - d) / 2,
            d = a),
            m ? (g = i + (n - u) / 2,
            f = (a - d) / 2) : (g = (n - u) / 2,
            f = (o - d) / 2),
    ...
    f.prototype.onScroll = function(e) {
        ...
        if (t.image.width && t.image.height) {
            var n = t.$item.getBoundingClientRect()
              ...
              , c = n;
            if (t.options.elementInViewport && (c = t.options.elementInViewport.getBoundingClientRect()),
            t.isElementInViewport = c.bottom >= 0 && c.right >= 0 && c.top <= a && c.left <= i,
            e || t.isElementInViewport) {
                var m = Math.max(0, o)
                  ...
                  , y = 1 - 2 * (a - o) / (a + l)
                  , v = 1;
                if (l < a ? v = 1 - (u || g) / l : p <= a ? v = p / a : f <= a && (v = f / a),
                ...
                if ("scroll" === t.options.type || "scroll-opacity" === t.options.type) {
                    ...
                    r && t.options.enableTransform ? (t.parentWithTransform && (b -= o),
                    s.transform = "translate3d(0, " + b + "px, 0)") : t.image.useImgTag ? s.top = b + "px" : (t.bgPosVerticalCenter && (b += t.bgPosVerticalCenter),
    ...
    var h = function(e) {
        ...
        for (a; a < i; a++)
            if ("object" == typeof n || "undefined" == typeof n ? e[a].jarallax || (e[a].jarallax = new f(e[a],n)) : e[a].jarallax && (t = e[a].jarallax[n].apply(e[a].jarallax, o)),
            "undefined" != typeof t)
                return t;
        return e
    };
